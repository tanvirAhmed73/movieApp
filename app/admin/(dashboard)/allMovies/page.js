...
const page = () => {
  return (
    <div className="grid mt-10 gap-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
      {movieData.map((movie) => (
        <div
          key={movie.id}
        ...
        >
          ...
          <div className="p-4">
            ...
            <div className="flex justify-between mt-4">
              ...
              <button className="bg-green-500 hover:bg-green-600 text-white py-2 px-4 rounded-md focus:outline-none">
                Comment
              </button>
            </div>
          </div>
